...
namespace Framework.Net
{
    ...
    public class HttpClient
    {
        ...
        /// </summary>
        public List<HttpUploadingFile> Files => files;

        /// <summary>
        /// 要发送的Form表单信息
        /// </summary>
        public Dictionary<string, string> PostingData => postingData;
        ...
        private HttpWebRequest CreateRequest()
        {
            ...
            if (verb == HttpVerb.POST)
            {
                ...
                else
                {
                    ...
                    foreach (string key in postingData.Keys)
                    {
                        sb.AppendFormat("{0}={1}&", UnityWebRequest.EscapeURL(key), UnityWebRequest.EscapeURL(postingData[key]));
                    }
                    if (sb.Length > 0)
                        sb.Length--;
    ...
    public class StatusUpdateEventArgs : EventArgs
    {
        ...
        public int BytesGot => bytesGot;

        /// <summary> 资源的总字节数 </summary>
        public int BytesTotal => bytesTotal;
    }
}