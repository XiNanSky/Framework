...
namespace Framework.Extend
{
    ...
    */
    ...
    /// 内存
    /// </summary>
    public static class ProfilerKit
    {
        [DllImport("kernel32")]
        ...
        public static long GetStorageMemoryTexture<T>(T obj) where T : UnityEngine.Texture
        {
            var method = AssemblyKit.GetMethodInfo("UnityEditor.dll", "UnityEditor.TextureUtil", "GetStorageMemorySize");
