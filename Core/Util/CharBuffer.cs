...
namespace Framework
{
    ...
    public class CharBuffer
    {
        ...
        public virtual int Top
        {
            ...
            set
            {
                if (value < offset) throw new SystemException(typeof(CharBuffer).Name + " setTop, invalid top:" + value);
        ...
        public virtual int Offset
        {
            ...
            set
            {
                if ((value < 0) || (value > top))
                    throw new SystemException(typeof(CharBuffer).Name + " setOffset, invalid offset:" + value);
                offset = value;
            }
        }
