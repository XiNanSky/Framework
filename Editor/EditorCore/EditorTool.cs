...
namespace Framework.Editor
{
    ...
    /// <summary> 自定义面板 工具集 </summary>
    public static class ETool
    {
        /// <summary> 自定义快捷方法 </summary>
        public static class EA
        {
            ...
            {
                for (int i = 0; i < num; i++) EditorGUILayout.Space(width);
            }
            ...
            /// <summary> 复制字符按钮 </summary>
            public static void ButtonCopyText(string name, float height, float width, string content)
            {

                if (height == -1 && width == -1)
                {
                    if (AC.Button(name, GStyleTool.button)) CopyTextAction(content);
                }
                else if (height == -1)
                {
                    if (AC.Button(name, GStyleTool.button, GUILayout.Width(width))) CopyTextAction(content);
                }
                else if (width == -1)
                {
                    if (AC.Button(name, GStyleTool.button, GUILayout.Height(height))) CopyTextAction(content);
                }
                else if (AC.Button(name, GStyleTool.button, GUILayout.Height(height), GUILayout.Width(width))) CopyTextAction(content);
            }
        ...
        public static class BE
        {
            ...
            /// <param name="options">整体显示格式</param>
            public static Vector2 ScrollView(Action action, Vector2 v, bool show_h, bool show_v, GUIStyle styles_h, GUIStyle styles_v, GUIStyle styles_b, params GUILayoutOption[] options)
            {
                if (action == null) return v;
            ...
            /// <param name="style">显示风格</param>
            /// <param name="options">整体显示格式</param>
            public static Vector2 ScrollView(Action action, Vector2 v, GUIStyle styles, params GUILayoutOption[] options)
            {
                if (action == null) return v;
            ...
            public static bool ToggleGroup(Action action, GUIContent label, bool toggle)
            {
            ...
            /// <param name="label">标签</param>
            /// <param name="toggle">显示开关</param>
            public static bool ToggleGroup(Action action, string label, bool toggle)
            {
                if (action == null) return false;
                toggle = EditorGUILayout.BeginToggleGroup(label, toggle);
                if (toggle) action();
            ...
            public static bool FoldoutHeaderGroup(Action action, bool foldout, string content, [DefaultValue("EditorStyles.foldoutHeader")] GUIStyle style = null, Action<Rect> menuAction = null, GUIStyle menuIcon = null)
            {
                if (action == null) return false;
                EA.Space();
            ...
            /// <param name="menuAction">操作菜单</param>
            /// <param name="menuIcon">菜单ICON显示风格</param>
            public static bool FoldoutHeaderGroup(Action action, bool foldout, GUIContent content, [DefaultValue("EditorStyles.foldoutHeader")] GUIStyle style = null, Action<Rect> menuAction = null, GUIStyle menuIcon = null)
            {
                if (action == null) return false;
                EA.Space();
                foldout = EditorGUILayout.BeginFoldoutHeaderGroup(foldout, content, style, menuAction, menuIcon);
        ...
        public static class AC
        {
            ...
            /// <summary> 按钮 Button </summary> 
            /// <param name="name"> 名字 </param>
            public static void Button(Action action, string name, params GUILayoutOption[] options)
            {
            ...
            /// <summary> 按钮 Button </summary> 
            /// <param name="name"> 名字 </param>
            public static void Button(Action action, GUIContent name, params GUILayoutOption[] options)
            {
                if (GUILayout.Button(name, options)) action();
            }
            ...
            /// <summary> 按钮 Button </summary> 
            /// <param name="name"> 名字 </param>
            public static void Button(Action action, string name, GUIStyle style, params GUILayoutOption[] options)
            {
            ...
            /// <summary> 按钮 Button </summary> 
            /// <param name="name"> 名字 </param>
            public static void Button(Action action, GUIContent name, GUIStyle style, params GUILayoutOption[] options)
            {
                if (GUILayout.Button(name, style, options)) action();
            }
            ...
            /// <summary> 按钮 Button </summary> 
            /// <param name="name"> 名字 </param>
            public static void Button(Action action, string name, float h, float w)
            {
                if (h == -1 && w == -1) { if (GUILayout.Button(name, GStyleTool.button)) { action(); } }
                else if (h == -1) { if (GUILayout.Button(name, GStyleTool.button, GUILayout.Width(w))) { action(); } }
                else if (w == -1) { if (GUILayout.Button(name, GStyleTool.button, GUILayout.Height(h))) { action(); } }
                else if (GUILayout.Button(name, GStyleTool.button, GUILayout.Height(h), GUILayout.Height(w))) action();
            }
        ...
        public class Scope
        {
            ...
            public class ScrollView : EditorGUILayout.ScrollViewScope
            {
                ...
                public ScrollView(Vector2 scrollPosition, bool alwaysShowHorizontal, bool alwaysShowVertical, params GUILayoutOption[] options) : base(scrollPosition, alwaysShowHorizontal, alwaysShowVertical, options) { }

                public ScrollView(Vector2 scrollPosition, GUIStyle horizontalScrollbar, GUIStyle verticalScrollbar, params GUILayoutOption[] options) : base(scrollPosition, horizontalScrollbar, verticalScrollbar, options) { }

                public ScrollView(Vector2 scrollPosition, bool alwaysShowHorizontal, bool alwaysShowVertical, GUIStyle horizontalScrollbar, GUIStyle verticalScrollbar, GUIStyle background, params GUILayoutOption[] options) : base(scrollPosition, alwaysShowHorizontal, alwaysShowVertical, horizontalScrollbar, verticalScrollbar, background, options) { }
