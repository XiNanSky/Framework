...
namespace Framework.Extend
{
    ...
    */
    ...
    public static class CultureInfoExtend
    {
        ...
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("Name : ").AppendLine(culture.Name.TOString());
            builder.Append("DisplayName : ").AppendLine(culture.DisplayName.TOString());
            builder.Append("EnglishName : ").AppendLine(culture.EnglishName.TOString());
            builder.Append("NativeName : ").AppendLine(culture.NativeName.TOString());
            builder.Append("ThreeLetterISOLanguageName : ").AppendLine(culture.ThreeLetterISOLanguageName.TOString());
            builder.Append("ThreeLetterWindowsLanguageName : ").AppendLine(culture.ThreeLetterWindowsLanguageName.TOString());
            builder.Append("TwoLetterISOLanguageName : ").AppendLine(culture.TwoLetterISOLanguageName.TOString());
            builder.Append("CultureTypes : ").AppendLine(culture.CultureTypes.TOString());
            builder.Append("IetfLanguageTag : ").AppendLine(culture.IetfLanguageTag.TOString());
            builder.Append("IsNeutralCulture : ").AppendLine(culture.IsNeutralCulture.TOString());
            builder.Append("IsReadOnly : ").AppendLine(culture.IsReadOnly.TOString());
            builder.Append("KeyboardLayoutId : ").AppendLine(culture.KeyboardLayoutId.TOString());
            builder.Append("LCID : ").AppendLine(culture.LCID.TOString());
            builder.Append("TextInfo : ").AppendLine(culture.TextInfo.TOString());
