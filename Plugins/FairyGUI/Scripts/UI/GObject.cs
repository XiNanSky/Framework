...
namespace FairyGUI
{
    public class GObject : EventDispatcher
    {
        ...
        /// <summary>
        /// The source width of the object. 物体的标准宽度 FGUI编辑器设置
        /// </summary>
        public int sourceWidth;

        /// <summary>
        /// The source height of the object. 物体的标准高度 FGUI编辑器设置
        /// </summary>
        public int sourceHeight;

        /// <summary>
        /// The initial width of the object. 当前对象初始宽度
        /// </summary>
        public int initWidth;

        /// <summary>
        /// The initial height of the object. 当前对象初始高度
        /// </summary>
        ...
        /// The bigger is the sorting order, the object is more in front. 排序越大 层级越靠前
        /// </summary>
        ...
        /// <summary>
        /// If the object can be focused? 物体是否可以聚焦
        /// </summary>
        ...
        /// <summary>
        /// If the object can be navigated by TAB? 物体是否可以通过键盘TAB键切换 2D游戏的自动跳转
        /// </summary>
        public bool tabStop
        {
        ...
        /// <summary>
        /// If the object is focused. 当前是否正在聚焦
        /// </summary>
        public bool focused
        {
        ...
        /// <summary>
        /// Request focus on this object. 请求开始聚焦
        /// </summary>
