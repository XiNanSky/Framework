        ...
        void OnGUI()
        {
            ...
            if (GUILayout.Button("OK", GUILayout.Width(100)) && selectedPackage >= 0)
            {
                ...
                if (Selection.activeGameObject == null && Selection.activeObject != null)
                {
                    ...
                    type.GetField("PackageName").SetValue(Selection.activeObject, selectedPkg.name);
                    type.GetField("ComponentName").SetValue(Selection.activeObject, selectedComponentName);
                    type.GetField("PackagePath").SetValue(Selection.activeObject, packagePath);
                }
