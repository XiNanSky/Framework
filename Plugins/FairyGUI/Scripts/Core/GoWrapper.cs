        ...
        void CloneMaterials()
        {
            ...
            for (int i = 0; i < cnt; i++)
            {
                ...
                for (int j = 0; j < mcnt; j++)
                {
                    ...
                    if (mat == null)
                        continue;
                    //bool flag = (mat.shader.name.IndexOf("RoleHair") == -1);
                    //if (shouldSetRQ && !flag)
                    //    mat.renderQueue = 3200;
                    //if (shouldSetRQ && mat.renderQueue != 3000 && flag) //Set the object rendering in Transparent Queue as UI objects
